...
users = User.create(
  [
    { email: 'a@a.com', name: "Mr. Aardvark", wallet: 400, cart: [1, 2, 3], wishlist: [4, 5, 6], password: "a", password_confirmation: "a"},
...
items = Item.create(
  [
    ...
    { filename: "s3.jpg", price: 60,  name: "PNY CS1311 240GB", owner_id: 1, on_sale: false, item_type: "solid_state_drive", purchased: 3, stock: 10, specs: ["Exceptional performance offering up to 550 MB/s seq. read and 520 MB/s seq. write speeds"] },
    { filename: "s4.jpg", price: 70, name: "SanDisk SSD 240GB", owner_id: 4, on_sale: false, item_type: "solid_state_drive", purchased: 10, stock: 10, specs: ["Sequential Read (up to) 520MB/s", "Sequential Write (up to) 350MB/s"] },
